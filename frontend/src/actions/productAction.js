...
export const listProducts = (keyword = '', pageNumber = '') => async (dispatch) => {
    try {
        ...
        dispatch({
            type: PRODUCT_ACTIONS.PRODUCT_LIST_FAILED,
            payload:
...
export const listProductDetails = (id) => async (dispatch) => {
    try {
        ...
        dispatch({
            type: PRODUCT_ACTIONS.PRODUCT_DETAILS_FAILED,
            payload:
                error.response && error.response.data.message
                    ? error.response.data.message
                    : error.message
...
export const deleteProduct = (id) => async (dispatch, getState) => {
    try {
        dispatch({ type: PRODUCT_ACTIONS.PRODUCT_DELETE_REQUEST });
        ...
        dispatch({
            type: PRODUCT_ACTIONS.PRODUCT_DELETE_FAILED,
            payload:
                error.response && error.response.data.message
                    ? error.response.data.message
                    : error.message
...
export const createProduct = () => async (dispatch, getState) => {
    try {
        dispatch({ type: PRODUCT_ACTIONS.PRODUCT_CREATE_REQUEST });
        ...
        dispatch({
            type: PRODUCT_ACTIONS.PRODUCT_CREATE_FAILED,
            payload:
                error.response && error.response.data.message
                    ? error.response.data.message
                    : error.message
...
export const updateProduct = (product) => async (dispatch, getState) => {
    try {
        dispatch({ type: PRODUCT_ACTIONS.PRODUCT_UPDATE_REQUEST });
        ...
        dispatch({
            type: PRODUCT_ACTIONS.PRODUCT_UPDATE_FAILED,
            payload:
                error.response && error.response.data.message
                    ? error.response.data.message
                    : error.message
...
export const createReviewProduct = (productId, review) => async (dispatch, getState) => {
    try {
        dispatch({ type: PRODUCT_ACTIONS.PRODUCT_CREATE_REVIEW_REQUEST });
        ...
        dispatch({
            type: PRODUCT_ACTIONS.PRODUCT_CREATE_REVIEW_FAILED,
            payload:
                error.response && error.response.data.message
                    ? error.response.data.message
                    : error.message
